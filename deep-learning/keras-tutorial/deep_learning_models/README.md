...
This project is actively maintained by Mustaq Sohail Shaik.

Mustaq is a Software Engineer with expertise in architecting and deploying intelligent systems, combining machine learning, data engineering, and scalable software design. He leverages Python, TensorFlow, and PyTorch to build production-grade models and deploy them in cloud-native environments.
